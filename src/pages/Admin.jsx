        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400">Manage GlyphLock platform and users</p>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="bg-gradient-to-br from-blue-500/10 to-blue-700/10 border-blue-500/30">
              <CardContent className="p-6">
                ...
                <div className="text-sm text-blue-400 font-semibold">Consultations</div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="bg-gray-900 border border-gray-800">
              ...
              <TabsTrigger value="users" className="text-white data-[state=active]:text-blue-400">
                <Users className="w-4 h-4 mr-2" />
                Users
              </TabsTrigger>
              <TabsTrigger value="payments" className="text-white data-[state=active]:text-blue-400">
              ...
              <TabsTrigger value="analytics" className="text-white data-[state=active]:text-blue-400">
                      ...
                      {consultations.slice(0, 5).map((consultation, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-800 rounded-lg">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-400">{consultation.service_interest}</div>
                          </div>
                          <Badge className={
                ...
                <Card className="bg-gray-900 border-gray-800">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                      ...
                      <Badge className="bg-blue-500/20 text-blue-400">124ms</Badge>
                    </div>
                  </CardContent>
                </Card>
              </div>
