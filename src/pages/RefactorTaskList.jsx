...
export default function RefactorTaskList() {
  const tasks = {
    ...
    high: [
      ...
      { id: 27, title: "User Profile Management - Settings Page", status: "in-progress", priority: "high" },
    ...
    medium: [
      ...
      { id: 27, title: "API Documentation - Developer Portal", status: "in-progress", priority: "medium" },
