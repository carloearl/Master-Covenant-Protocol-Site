...
export default function RefactorTaskList() {
  const tasks = {
    ...
    high: [
      ...
      { id: 21, title: "Refund System - Customer Service", status: "in-progress", priority: "high" },
      { id: 22, title: "Bulk Voucher Purchase - Enterprise Features", status: "in-progress", priority: "high" },
      { id: 23, title: "Partner Management - Venue Integration", status: "in-progress", priority: "high" },
    ...
    medium: [
      ...
      { id: 28, title: "Voucher Transfer System - P2P Transfers", status: "in-progress", priority: "medium" },
      { id: 29, title: "Subscription Management - Recurring Vouchers", status: "completed", priority: "medium" },
      { id: 30, title: "Gift Card Feature - Send to Friends", status: "in-progress", priority: "medium" },
      { id: 31, title: "Loyalty Program - Rewards System", status: "completed", priority: "medium" },
      { id: 32, title: "Promo Codes - Discount System", status: "in-progress", priority: "medium" },
      ...
      { id: 44, title: "2FA Authentication - Enhanced Security", status: "in-progress", priority: "medium" },
