  ...
  useEffect(() => {
    ...
    class Node {
      constructor() {
        ...
        this.color = `hsla(${Math.random() * 40 + 200}, 70%, ${Math.random() * 20 + 50}%, ${Math.random() * 0.2 + 0.2})`;
      }
    ...
    function animate() {
      ...
      cursorGradient.addColorStop(0, "rgba(65, 105, 225, 0.5)");
      cursorGradient.addColorStop(0.5, "rgba(65, 105, 225, 0.25)");
