...
export default function HomeDreamTeamCTA() {
  return (
    <section className="relative w-full py-20 overflow-hidden mt-20 mx-auto max-w-7xl rounded-3xl">
      ...
      {/* CONTENT */}
      <div className="relative z-20 flex flex-col items-center text-center px-6 py-12">
        ...
        <p className="text-cyan-300 text-3xl md:text-4xl font-black mb-12 drop-shadow-[0_4px_12px_rgba(0,0,0,1)]">
        ...
        <Link to={createPageUrl("DreamTeam")}>
          <div className="relative group cursor-pointer transition-all duration-300 hover:scale-110 active:scale-95">
            ...
            {/* GLOW */}
            <div className="absolute inset-0 rounded-full blur-3xl opacity-80 group-hover:opacity-100 transition-opacity" style={{ background: 'radial-gradient(circle, rgba(168,85,247,1), rgba(99,102,241,0.8), transparent)' }}></div>
            ...
            <img
              ...
              className="relative w-64 h-64 drop-shadow-[0_0_60px_rgba(168,85,247,1)] group-hover:drop-shadow-[0_0_100px_rgba(168,85,247,1)] transition-all"
            />
